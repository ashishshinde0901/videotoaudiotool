...
# We import the page-specific modules so we can delegate calls.
from . import home_page
from . import youtube_page
from . import local_processing_page
...
class RianVideoProcessingTool(ctk.CTk):
    ...
    def __init__(self):
        ...
        self.init_navbar()
        self.init_homepage()  # Default homepage
    ...
    def init_homepage(self):
        """Load the home/welcome page (delegated)."""
        home_page.init_homepage(self)

    ###########################################################################
    #                       YOUTUBE DOWNLOAD DELEGATION
    ###########################################################################

    def init_youtube_download(self):
        """UI for downloading from YouTube (video or playlist) (delegated)."""
        youtube_page.init_youtube_download(self)

    ###########################################################################
    #                     LOCAL PROCESSING DELEGATION
    ###########################################################################

    def init_local_processing(self):
        """UI for local video processing (delegated)."""
        local_processing_page.init_local_processing(self)